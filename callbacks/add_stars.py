...
class AddStarDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # --- Row 0: Label
        descr_label = 'Search for a star. Use English names (e.g. <b>Arcturus</b>)'
        grid.addWidget(QLabel(descr_label), 0, 0, 1, 7)

        # --- Row 1: Star Name + Check
        grid.addWidget(QLabel('Star Name'), 1, 0, 1, 1)
        self.star_name_field = QLineEdit()
        grid.addWidget(self.star_name_field, 1, 1, 1, 4)
        ...
        # --- Row 2: RA / Dec ---
        grid.addWidget(QLabel('RA2000'), 2, 0, 1, 1)
        ...
        grid.addWidget(self.ra_field, 2, 1, 1, 2)

        grid.addWidget(QLabel('Dec2000'), 2, 4, 1, 1)
        ...
        grid.addWidget(self.dec_field, 2, 5, 1, 2)

        # --- Row 3: pm_ra / pm_dec ---
        grid.addWidget(QLabel('pm_ra'), 3, 0, 1, 1)
        ...
        grid.addWidget(self.pm_ra_field, 3, 1, 1, 2)

        grid.addWidget(QLabel('pm_dec'), 3, 4, 1, 1)
        ...
        grid.addWidget(self.pm_dec_field, 3, 5, 1, 2)

        # --- Row 4: Vizier Name and buttons ---
        grid.addWidget(QLabel('Vizier Name'), 4, 0)
        ...
        grid.addWidget(self.vizier_field, 4, 1, 1, 2)
